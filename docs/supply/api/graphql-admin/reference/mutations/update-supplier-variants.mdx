...
#### [`externalInputs`](#) ([`[SupplierVariantExternalUpdateInput]`](/supply/api/graphql-admin/reference/inputs/supplier-variant-external-update-input))




#### [`inputs`](#) ([`[SupplierVariantUpdateInput]`](/supply/api/graphql-admin/reference/inputs/supplier-variant-update-input))
