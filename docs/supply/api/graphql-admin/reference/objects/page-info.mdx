...
#### [`endCursor`](#) ([`String`](/supply/api/graphql-admin/reference/scalars/string))

The cursor to use when paginating forwards (using first/after). Will always be
populated regardless of if a next page exists.


#### [`hasNextPage`](#) ([`Boolean!`](/supply/api/graphql-admin/reference/scalars/boolean))
...
#### [`hasPreviousPage`](#) ([`Boolean!`](/supply/api/graphql-admin/reference/scalars/boolean))
...
#### [`startCursor`](#) ([`String`](/supply/api/graphql-admin/reference/scalars/string))
