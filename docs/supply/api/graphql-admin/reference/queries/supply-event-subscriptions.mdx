...
#### [`eventSubscriptionIds`](#) ([`[ID!]`](/supply/api/graphql-admin/reference/scalars/id))
...
#### [`SupplyEventSubscriptionConnection`](/supply/api/graphql-admin/reference/objects/supply-event-subscription-connection)
