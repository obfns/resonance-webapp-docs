...
#### [`endCursor`](#) ([`String`](/adminidentity/api/graphql-admin/reference/scalars/string))

The cursor to use when paginating forwards (using first/after). Will always be
populated regardless of if a next page exists.


#### [`hasNextPage`](#) ([`Boolean!`](/adminidentity/api/graphql-admin/reference/scalars/boolean))
...
#### [`hasPreviousPage`](#) ([`Boolean!`](/adminidentity/api/graphql-admin/reference/scalars/boolean))
...
#### [`startCursor`](#) ([`String`](/adminidentity/api/graphql-admin/reference/scalars/string))
