...
#### [`endCursor`](#) ([`String`](/demand/api/graphql-storefront/reference/scalars/string))

The cursor to use when paginating forwards (using first/after). Will always be
populated regardless of if a next page exists.


#### [`hasNextPage`](#) ([`Boolean!`](/demand/api/graphql-storefront/reference/scalars/boolean))
...
#### [`hasPreviousPage`](#) ([`Boolean!`](/demand/api/graphql-storefront/reference/scalars/boolean))
...
#### [`startCursor`](#) ([`String`](/demand/api/graphql-storefront/reference/scalars/string))
