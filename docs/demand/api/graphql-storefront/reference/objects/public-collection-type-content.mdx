...
#### [`collectionTypeContentId`](#) ([`ID!`](/demand/api/graphql-storefront/reference/scalars/id))
...
#### [`tags`](#) ([`CollectionTypeContentTags`](/demand/api/graphql-storefront/reference/objects/collection-type-content-tags))
