...
#### [<code style={{ fontWeight: 'normal' }}>changeCustomerCart.<b>addOrUpdateItems</b></code>](#)<Bullet />[`CartAddOrUpdateItemsInput`](/demand/api/graphql-storefront/reference/inputs/cart-add-or-update-items-input) <Badge class="secondary" text="input"/>
...
#### [<code style={{ fontWeight: 'normal' }}>changeCustomerCart.<b>customerToken</b></code>](#)<Bullet />[`String!`](/demand/api/graphql-storefront/reference/scalars/string) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>
> 
> 

#### [<code style={{ fontWeight: 'normal' }}>changeCustomerCart.<b>removeItems</b></code>](#)<Bullet />[`CartRemoveItemsInput`](/demand/api/graphql-storefront/reference/inputs/cart-remove-items-input) <Badge class="secondary" text="input"/>
