...
#### [`endCursor`](#) ([`String`](/demand/api/graphql-admin/reference/scalars/string))

The cursor to use when paginating forwards (using first/after). Will always be
populated regardless of if a next page exists.


#### [`hasNextPage`](#) ([`Boolean!`](/demand/api/graphql-admin/reference/scalars/boolean))
...
#### [`hasPreviousPage`](#) ([`Boolean!`](/demand/api/graphql-admin/reference/scalars/boolean))
...
#### [`startCursor`](#) ([`String`](/demand/api/graphql-admin/reference/scalars/string))
