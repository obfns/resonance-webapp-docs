...
#### [`externalCustomerIdFieldName`](#) ([`String`](/demand/api/graphql-admin/reference/scalars/string))

Required for authenticationType JWKS. This is the name of the field containing the customerId, normally 'sub'


#### [`issuer`](#) ([`String!`](/demand/api/graphql-admin/reference/scalars/string))

Required for authenticationType COGNITO or JWKS. This indicates the issuer of the JWT.


#### [`jwksUrl`](#) ([`String`](/demand/api/graphql-admin/reference/scalars/string))
