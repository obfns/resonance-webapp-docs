...
#### [`all`](#) ([`[CollectionRuleInput]`](/demand/api/graphql-admin/reference/inputs/collection-rule-input))

ALL of the rules for this array must match a given prospective Product


#### [`any`](#) ([`[CollectionRuleInput]`](/demand/api/graphql-admin/reference/inputs/collection-rule-input))

ANY of the rules for this array must match a given prospective Product


#### [`not`](#) ([`[CollectionRuleInput]`](/demand/api/graphql-admin/reference/inputs/collection-rule-input))
