...
[`TaxonomyBranch`](/demand/api/graphql-admin/reference/objects/taxonomy-branch)  <Badge class="secondary" text="object"/><Bullet />[`TaxonomyBranchCreateInput`](/demand/api/graphql-admin/reference/inputs/taxonomy-branch-create-input)  <Badge class="secondary" text="input"/>
