...
#### [`input`](#) ([`CollectionImageFromUrlInput!`](/demand/api/graphql-admin/reference/inputs/collection-image-from-url-input))
...
#### [`Collection`](/demand/api/graphql-admin/reference/objects/collection)
